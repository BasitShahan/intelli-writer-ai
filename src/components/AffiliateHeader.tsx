...
const AffiliateHeader = () => {
  ...
  const navbar = [
    ...
    { id: 4, title: "Rewards", link: "/affiliates/rewards" },
    { id: 5, title: "Payouts", link: "/affiliates/payouts" },
    { id: 6, title: "Assets", link: "/affiliates/asset" },
    { id: 7, title: "Profile", link: "/affiliates/profile" }
  ];
  ...
  return (
    <header className="flex items-center sticky top-0 z-50 w-full">
      ...
      <div className="text-white font-extrabold text-[24px] tracking-wide font-montserrat">
        <Image src={Logo} alt="Logo" width={380} height={50} className="object-contain h-16 w-auto" />
      </div>
    </Link>
      ...
      >
        ...
        <Link href="/affiliates/dashboard" >
            <Image src={Logo} alt="Logo" width={180} height={18} className="pl-5 pt-3 w-20" />
          </Link>
