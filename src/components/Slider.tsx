        ...
        <div className='w-full flex flex-col gap-3 py-10 pt-0 justify-center items-center ' id='/about'>
            <div className='xl:px-16 md:px-6 px-4 py-10 w-full container'>
                <h2 className='lg:text-6xl text-5xl font-normal relative lg:p-10 md:p-6 p-4'>
                    ...
                    <span className='gradient-span-1 text-white relative lg:p-6 p-6 font-[600]'>IMAGES & NFTS</span>
                </h2>
                <p className='md:text-[21px] text-[16px] font-[500] leading-[36px] !text-white lg:px-10 md:p-6 p-4'>Begin your creative odyssey with Images & NFTs. Immerse yourself in a realm where art merges with innovation, enabling exploration, creation, and sharing of your distinct vision through digital marvels and NFTs. Start now to ignite limitless digital creativity.</p>
            </div>
