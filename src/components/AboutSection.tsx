...
import { image_text, nft_2 } from "../../public";
...
const AboutSection = () => {
  return (
    <div className="flex flex-wrap w-full justify-center">
      <div className="flex lg:flex-row flex-col items-center justify-evenly w-full lg:gap-6 gap-8 container py-10 px-4">
        <div className="relative rounded-[24px] ">
          <div className="relative overflow-hidden rounded-[24px]">
            <img src="/image-gen.webp" alt="" className="w-[600px] h-auto " />
          </div>
        </div>
      ...
      <div className="flex lg:flex-row flex-col-reverse items-center justify-evenly w-full lg:gap-2 gap-8 container py-10 px-4">
        <div className="flex flex-col justify-center items-center lg:w-1/2 w-full text-left">
        ...
        <div className=" relative rounded-[24px] ">
          <div className="relative overflow-hidden rounded-[24px]">
            <img src="/voice-over.webp" alt="" className="w-[600px] h-auto " />
          </div>
        </div>
      </div>
    </div>
