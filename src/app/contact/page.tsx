...
const ContactPageLayout: React.FC<ContactPageLayoutProps> = () => {
  ...
  return (
    <div className="pt-4">
      ...
      {/* Contact Content */}
      <div className="relative z-40 min-h-screen lg:py-20 py-10 md:p-10 lg:mt-[-100px] xl:pt-[160px] flex items-center justify-center">
        <section className="z-10 container flex justify-center items-center">
          <div className="border-2 border-opacity-10 md:max-w-[800px] border-white rounded-3xl z-20">
